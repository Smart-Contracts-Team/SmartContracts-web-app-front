...
async function handleRegister() {
  ...
  try {
    ...
    if (response.success) {
      ...
      Object.keys(errorValidation).forEach(
        (key) => (errorValidation[key as keyof typeof errorValidation].value = '')
      )
    } else {
      ...
      >
        ...
        >
          ...
          <div>
            ...
            />
            <p v-if="errorValidation.usernameError" class="text-red-500 text-xs mt-1">
              {{ errorValidation.usernameError }}
            </p>
            ...
            <InputText
              ...
              class="w-full md:w-[30rem] mb-8"
            />
            <p v-if="errorValidation.locationError" class="text-red-500 text-xs mt-1">
              {{ errorValidation.locationError }}
            </p>
            ...
            <InputText
              ...
              class="w-full md:w-[30rem] mb-8"
            />
            <p v-if="errorValidation.rucError" class="text-red-500 text-xs mt-1">
              {{ errorValidation.rucError }}
            </p>

            <h4 class="text-surface-900 dark:text-surface-0 font-bold text-2xl mb-6">
            ...
            <InputText
              ...
              class="w-full md:w-[30rem] mb-8"
            />
            <p v-if="errorValidation.firstNameError" class="text-red-500 text-xs mt-1">
              {{ errorValidation.firstNameError }}
            </p>
            ...
            <InputText
              ...
              class="w-full md:w-[30rem] mb-8"
            />
            <p v-if="errorValidation.lastNameError" class="text-red-500 text-xs mt-1">
            ...
            <InputText
              ...
              class="w-full md:w-[30rem] mb-8"
            />
            <p v-if="errorValidation.emailError" class="text-red-500 text-xs mt-1">
            ...
            <Password
              ...
              :feedback="false"
            ></Password>
            <p v-if="errorValidation.passwordError" class="text-red-500 text-xs mt-1">
            ...
            <InputText
              ...
              class="w-full md:w-[30rem] mb-8"
            />
            <p v-if="errorValidation.phoneError" class="text-red-500 text-xs mt-1">
